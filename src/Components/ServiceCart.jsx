...
const ServiceCart = ({className, IconPart, HeadingPart, DetailsPart}) => {
  return (
    <div className={`${className} py-[34px] px-[30px] text-center w-[395px] shadow-2xl bg-bgcart rounded-3xl `}>
        ...
        <h3 className='text-xl font-bold tracking-[2px] text-orange leading-14 pt-4'>{HeadingPart}</h3>
        <p className='pt-[16px] text-xl font-medium text-whiteDark leading-8'>{DetailsPart}</p>
    </div>
  )
}
