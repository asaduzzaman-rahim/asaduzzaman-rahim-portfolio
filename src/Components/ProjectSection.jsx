    ...
    <>
     <Section className="!bg-[#0b0410]">
        <Container>
            ...
            <Flex className="max-w-[1130px] mx-auto rounded-[15px] flex-col-reverse lg:flex-row lg:justify-between lg:items-center gap-[35px] overflow-hidden px-[15px] py-[30px] xl:py-[50px] xl:pl-[35px] xl:pr-[45px] mb-0 md:mb-[25px] my-10 bg-ThereColor ">
                <div className='max-w-[380px]'>
                    ...
                    <ul className="mt-[30px] mb-[100px] flex gap-3 ">
                    ...
                    <button className='text-white'>View Live Project</button>
